...
mixin _$Paths {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, appSupportDir, appCacheDir, tempDir);

  @override
  String toString() {
    return 'Paths(appSupportDir: $appSupportDir, appCacheDir: $appCacheDir, tempDir: $tempDir)';
  }
}
...
abstract mixin class $PathsCopyWith<$Res> {
  factory $PathsCopyWith(Paths value, $Res Function(Paths) _then) =
      _$PathsCopyWithImpl;
  @useResult
  $Res call({String appSupportDir, String appCacheDir, String tempDir});
}
...
extension PathsPatterns on Paths {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String appSupportDir, String appCacheDir, String tempDir)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Paths() when $default != null:
        return $default(_that.appSupportDir, _that.appCacheDir, _that.tempDir);
      case _:
        return orElse();
    }
  }
...
mixin _$Settings {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, port, paths, version);

  @override
  String toString() {
    return 'Settings(port: $port, paths: $paths, version: $version)';
  }
}
...
abstract mixin class $SettingsCopyWith<$Res> {
  ...
  @useResult
  $Res call({int port, Paths paths, String version});
...
extension SettingsPatterns on Settings {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int port, Paths paths, String version)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _Settings implements Settings {
  const _Settings(
      {required this.port, required this.paths, required this.version});
